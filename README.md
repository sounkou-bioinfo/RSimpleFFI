...
#> 1 native_r       13µs   28.1µs    35685.    78.2KB        0
#> 2 ffi_call     95.1µs   99.7µs     9754.    78.7KB        0
dll_unload(lib_path)
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 r             2.5ms   2.67ms      362.    78.2KB     19.0
#> 2 c_ffi       101.4µs 116.43µs     8025.    78.7KB      0
