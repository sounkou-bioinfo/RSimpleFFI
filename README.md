...
#> 1 native_r     13.1µs     29µs    34420.    78.2KB        0
#> 2 ffi_call     91.5µs   96.2µs    10149.    78.7KB        0
dll_unload(lib_path)
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 r            2.44ms   2.63ms      371.    78.2KB     19.5
#> 2 c_ffi        99.3µs 112.34µs     8387.    78.7KB      0
