...
#> 1 native_r     13.2µs   28.9µs    33652.    78.2KB        0
#> 2 ffi_call     95.7µs    102µs     9630.    78.7KB        0
dll_unload(lib_path)
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 r            2.45ms   2.65ms      372.    78.2KB     19.6
#> 2 c_ffi      100.26µs 117.96µs     8194.    78.7KB      0
