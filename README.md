...
#> 1 native_r     13.2µs   29.3µs    33966.    78.2KB        0
#> 2 ffi_call     92.9µs   97.2µs    10049.    78.7KB        0
dll_unload(lib_path)
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 r             2.5ms   2.67ms      364.    78.2KB     19.2
#> 2 c_ffi        97.4µs 113.97µs     8459.    78.7KB      0
