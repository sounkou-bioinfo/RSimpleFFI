...
RSimpleFFI is inspired by the [Rffi package](https://github.com/omegahat/Rffi/) by Duncan Temple Lang, which pioneered R-to-C FFI interfaces. RSimpleFFI builds on these concepts with modern S7 classes and enhanced type safety.
