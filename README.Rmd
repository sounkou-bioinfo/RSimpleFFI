...
Current limitations include unnecessary copying, lack of protection, potential memory leaks, and type objects that are never finalized. We do not support complex types. No facility to generate interfaces from C header files (see [RGCCTranslationUnit](https://github.com/omegahat/RGCCTranslationUnit)).
