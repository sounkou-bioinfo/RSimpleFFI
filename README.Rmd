...
The generated code compiles with `R CMD SHLIB` and uses the C compiler's layout calculations, handling bitfields and platform-specific alignment automatically.
