...
classes. Supports calling 'C' functions with some type conversion.
Includes standard 'C' types (int8, int16, int32, int64, uint variants),
platform types (size_t, bool), and floating point types.
