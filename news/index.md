...
- Escape non-syntactic C bit-field names in generated R bindings,
  including names from platform headers such as `_flags2`.

- Build the API-mode test library using R’s platform shared-library
